    ...
    <section class="sidebar">
      ...
      <?php if ($this->session->userdata('status') == 'admin_login') { ?>
            ...
            <li <?= $this->uri->segment(1) == 'soal_ujian' ? 'class="active"' : '' ?>>
              <a href="<?php echo base_url('soal_ujian'); ?>"><i class="fa fa-circle-o"></i> Kelola Soal Latihan</a>
            </li>
             <li <?= $this->uri->segment(1) == 'peserta' ? 'class="active"' : '' ?>>
              <a href="<?php echo base_url('peserta'); ?>"><i class="fa fa-circle-o"></i> Kelola Peserta Latihan</a>
            </li>
            <li <?= $this->uri->segment(1) == 'hasil_ujian' ? 'class="active"' : '' ?>>
              <a href="<?php echo base_url('hasil_ujian'); ?>"><i class="fa fa-circle-o"></i> Hasil Latihan Soal</a>
            </li>
